/* auth.js — Login & Sign Up flow using Standard Email + Password */
'use strict';
...
window.switchAuthTab = function(tab) {
  // Preserve email input state if switching
...
window.handleAuthSubmit = async function(e, type) {
  ...
  try {
    ...
    setTimeout(() => {
      // The app handles onboarding redirect internally in handleRoute()
      App.navigate('/');
